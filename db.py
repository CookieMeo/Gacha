...
PETS_DATA = [
    ...
    ("Зеленый Ежик", "Зеленое", "assets/hedgehog.png", 0, "Колючки: небольшой шанс нанести урон"),
    ("Голубой Птиц", "Голубое", "assets/bird.png", 0, "Песня: шанс увеличить скорость клика"),
    ("Фиолетовый Кристалл", "Фиолетовое", "assets/crystal.png", 0, "Свечение: увеличивает шанс выпадения редких предметов"),
]
